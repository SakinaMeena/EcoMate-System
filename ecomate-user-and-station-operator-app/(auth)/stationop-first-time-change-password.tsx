...
export default function StationOpFirstTimeChangePassword() {
  ...
  const handleUpdatePassword = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Password Updated",
        "Your password has been updated successfully. You can now access your dashboard.",
        [
          {
            text: "Continue",
            onPress: () =>
      ...
      >
        <View style={styles.topSection}>
          ...
          >
            ...
            For security reasons, please create a new password before
            accessing the station dashboard.
          </AppText>
        </View>
